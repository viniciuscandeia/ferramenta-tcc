...
Fonte: IMS Global Learning Consortium "Learning Management Systems Interoperability" (2020) imsglobal.org; ISO/IEC 19796-1:2005 "IT — Learning, education and training — Quality management"; sistematizado por análise de domínio de plataformas LMS (Moodle, Canvas, Blackboard). Livro 1 (cenários de uso — identificação pendente, ver references/normas/README.md).
