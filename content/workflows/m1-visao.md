...
[4] clarificacao-pos-visao  ← CONDICIONAL (D16)
  ...
  ▼
[5] traducao-gate
  │  → Lê template content/templates/01-documento-visao.md para Fase 1 (M1 — sem EARS)
...
|---|---|---|
| `documentos-tecnicos/01-visao/01-visao-produto.md` | Documento de Visão (ISO 29148) — template `content/templates/01-documento-visao.md` | 350–700 palavras |
