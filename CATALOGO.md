...
**Workflow:** `core/core/workflows/m1-visao.md`  
...
**Workflow:** `core/workflows/core/workflows/m2-requisitos.md`  
...
**Workflow:** `core/workflows/core/workflows/m2-requisitos.md` (Fase B)  
...
**Workflow:** `core/workflows/core/workflows/m3-srs-specs-tests.md` (Fase A)  
...
**Workflow:** `core/workflows/core/workflows/m3-srs-specs-tests.md` (Fase B)  
...
**Arquivo:** `core/core/workflows/m1-visao.md`  
...
**Arquivo:** `core/workflows/core/workflows/m2-requisitos.md`  
...
**Arquivo:** `core/workflows/core/workflows/m3-srs-specs-tests.md`  
...
|---|---|
| Entender a sequência completa M1→M2→M3 | `core/core/workflows/m1-visao.md` → `core/workflows/m2-requisitos.md` → `core/workflows/m3-srs-specs-tests.md` |
...
| Catálogos seed (stakeholders, RFs, domínios) | `ferramenta-tcc/core/catalogos-seed/` |
