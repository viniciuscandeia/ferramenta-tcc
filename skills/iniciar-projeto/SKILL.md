...
3. Todas as referências a arquivos do plugin = `{PLUGIN_ROOT}/<arquivo>` (sem diretório `core/` desde v0.13.0 — estrutura flat na raiz)
...
O orquestrador irá:
1. Ler `{PLUGIN_ROOT}/constitution.md` e internalizar as regras D1/D3/D14/D15 como invioláveis.
