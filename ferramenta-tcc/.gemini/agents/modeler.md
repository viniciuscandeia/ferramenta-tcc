...
8. Executar as skills na ordem definida em "Loop M2 — fallback single-session / Bloco MODELER" de `core/marcos/m2.md`, chamando cada skill por nome explícito ("Use skill `<nome>` agora.") — não aguardar auto-invocação (C1/C2)
